...
Supporting Large Screen and Foldable devices uses the new AndroidApplication.onConfigurationChanged callback that is available in Unity 6.  The Unity build option for resizable screens is also required, as well as considerations in the layout of your camera and UI canvases.
